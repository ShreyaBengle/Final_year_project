...
def process_text_and_display_videos(text):
    ...
    #                 # Note: This is necessary to avoid overwhelming the Streamlit app
    #                 time.sleep(0.03)
    #             cap.release()
    #             break
...
with col1:
   ...
   if stopDetectv5:
    file_path = "D:/ENGG/SEM 8/B.TECH PROJECT/yolov5v8streamlit/runs/detect/exp42/unique_classes.txt"
